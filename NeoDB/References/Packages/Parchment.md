...
- [Options](#options)
    ...
    - [`menuItemLabelSpacing`](#menuitemlabelspacing)
    - [`menuInsets`](#menuinsets)
    - [`menuHorizontalAlignment`](#menuhorizontalalignment)
    ...
    - [`includeSafeAreaInsets`](#includesafeareainsets)
    - [`font`](#font)
