        ...
        var feature: Feature {
            ...
            case .integration:
                return Feature(
                    ...
                    title: String(localized: "store_feature_integration_title", table: "Settings"),
                    description: String(localized: "store_feature_integration_description", table: "Settings"),
                    color: .blue
                )
            case .customize:
                return Feature(
