...
// actor MastodonTimelinesCache {
//     private func storageFor(_ client: String, _ filter: String)
//         -> SQLiteStorageEngine
//     {
//         if filter == "Home" {
...
//         do {
//             let directory = FileManager.Directory.defaultStorageDirectory(
//                 appendingPath: client
//             ).url
...
//                     total += await storageFor(client, storage.lastPathComponent)
//                         .allKeys().count
//                 }
//             }
//             return total
...
//         let statuses = statuses.prefix(upTo: min(600, statuses.count - 1)).map {
//             $0
//         }
//         do {
//             let engine = storageFor(client, filter)
...
//     func setLatestSeenStatuses(
//         _ statuses: [Status], for client: Client, filter: String
//     ) {
//         let statuses = statuses.sorted(by: {
//             $0.createdAt.asDate > $1.createdAt.asDate
//         })
//         if filter == "Home" {
//             UserDefaults.standard.set(
//                 statuses.map { $0.id },
//                 forKey: "timeline-last-seen-\(client.id)")
//         } else {
//             UserDefaults.standard.set(
//                 statuses.map { $0.id },
//                 forKey: "timeline-last-seen-\(client.id)-\(filter)")
//         }
//     }
...
//                 forKey: "timeline-last-seen-\(client.id)") as? [String]
//         } else {
//             UserDefaults.standard.array(
//                 forKey: "timeline-last-seen-\(client.id)-\(filter)")
//                 as? [String]
